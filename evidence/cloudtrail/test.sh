...
aws s3 cp s3://sec-app-cloudtrail-logs-$ACCOUNT_ID/AWSLogs/$ACCOUNT_ID/CloudTrail/eu-west-3/2026/09/19/${ACCOUNT_ID}_CloudTrail_eu-west-3_20260919T2220Z_yioxVq3W623BVfja.json.gz ./test_log.gz
